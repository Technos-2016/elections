...
function IsBsValid(dates) {
    var dateArr = dates.split('/').map(function (str) {
        return Number(str);
    });
    try {
        var isValidYear = dateArr[0] in bsCalendarData;
        var isValidMonth = dateArr[1] <= 12;
        var isValidDay = isValidMonth && dateArr[2] > 0 && dateArr[2] <= bsCalendarData[dateArr[0]][dateArr[1] - 1];
